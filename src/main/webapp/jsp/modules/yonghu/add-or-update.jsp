                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuXuexiaoDiv">
                                        <label>毕业学校</label>
                                        <input style="width: 450px" id="yonghuXuexiao" name="yonghuXuexiao" class="form-control"
                                               placeholder="毕业学校">
                                    </div>
