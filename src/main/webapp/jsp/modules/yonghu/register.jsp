...
<body style="background-image:url('/cailiaogongsi/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>毕业学校</label>
                                    <input id="yonghuXuexiao" name="yonghuXuexiao" class="form-control"
                                           placeholder="毕业学校">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>
